"""Bài nộp cá nhân Lab 07 của Trần Nguyễn Thế Nhật."""
...
from .embeddings import EMBEDDING_PROVIDER_ENV, LOCAL_EMBEDDING_MODEL, OPENAI_EMBEDDING_MODEL, LocalEmbedder, MockEmbedder, OpenAIEmbedder, _mock_embed
...
__all__ = [
    ...
    "_mock_embed", "LOCAL_EMBEDDING_MODEL", "OPENAI_EMBEDDING_MODEL", "EMBEDDING_PROVIDER_ENV",
]
